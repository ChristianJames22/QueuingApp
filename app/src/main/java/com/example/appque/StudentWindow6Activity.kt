...
class StudentWindow6Activity : AppCompatActivity() {
    ...
    private fun fetchCurrentQueueNumber() {
        database.child("window6Queue").child("currentQueueNumber")
    ...
    private fun setupRealTimeUserActiveAppointmentListener() {
        database.child("window6Queue").child("appointments")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
    ...
    private fun observeWindow6Status() {
    ...
    private fun addAppointment(selectedAppointment: String) {
        ...
        database.child("window6Queue").child("appointments").push().setValue(appointment)
            .addOnSuccessListener {
                database.child("window6Queue").child("currentQueueNumber").setValue(currentQueueNumber);
