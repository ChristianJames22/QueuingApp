...
class StudentWindow6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_student_window6)
        ...
        Log.d("StudentWindow6Activity", "Received Data -> Name: $userName, ID: $userIdNumber, Course: $userCourse, Year: $userYear")
